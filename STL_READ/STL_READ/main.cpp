...
int main() {
    ...
    /*for (int i = 0; i < triangles.size(); i++)
    {
        ...
        std::cout << triangles[i].v1[0] << " " << triangles[i].v1[1] << " " << triangles[i].v1[2] << std::endl;;

        std::cout << triangles[i].v2[0] << " " << triangles[i].v2[1] << " " << triangles[i].v2[2] << std::endl;;

        std::cout << triangles[i].v3[0] << " " << triangles[i].v3[1] << " " << triangles[i].v3[2] << std::endl << std::endl;
    }*/
